...
#SBATCH --job-name=vary-total-low-variance
...
# Usage: sbatch vary-total-low-variance.sh <dataset> <llm> <n_expert>
# Example: sbatch vary-total-low-variance.sh cuad llama 50
DATASET=$1
LLM=$2
N_EXPERT=$3
