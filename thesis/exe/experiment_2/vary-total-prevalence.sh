...
#SBATCH --output=/cephyr/users/kesaf/Vera/llm-debiasing-benchmark/thesis/logs/vary-total-prevalence/%x_%A_%a.log
#SBATCH --error=/cephyr/users/kesaf/Vera/llm-debiasing-benchmark/thesis/logs/vary-total-prevalence/%x_%A_%a.err
...
mkdir -p "${CODE_DIR}/thesis/logs/vary-total-prevalence"
