...
#SBATCH --job-name=vary-expert-low-variance
...
#SBATCH --output=/cephyr/users/kesaf/Vera/llm-debiasing-benchmark/thesis/logs/vary-expert-low-variance/%x_%A_%a.log
#SBATCH --error=/cephyr/users/kesaf/Vera/llm-debiasing-benchmark/thesis/logs/vary-expert-low-variance/%x_%A_%a.err
...
apptainer exec \
    ...
    --pwd /code \
    ${CONTAINER_PATH} \
    python3 /code/thesis/lib/experiments/experiment_vary_experts/expert_low_variance.py \
        "${ANNOTATED_CSV}" \
