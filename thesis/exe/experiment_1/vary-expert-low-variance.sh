...
#SBATCH --output=/mimer/NOBACKUP/groups/ci-nlp-alvis/logs/vary-expert-low-variance/%x_%A_%a.log
#SBATCH --error=/mimer/NOBACKUP/groups/ci-nlp-alvis/logs/vary-expert-low-variance/%x_%A_%a.err
...
mkdir -p /mimer/NOBACKUP/groups/ci-nlp-alvis/logs/vary-expert-low-variance
