"""
Step 1 of 2: Annotate a parsed dataset CSV using DeepSeek, OpenAI, or Anthropic.
...
Arguments:
    api             Which API to use: "deepseek", "openai", or "anthropic"
...
if __name__ == "__main__":
    ...
    parser.add_argument("api", choices=["deepseek", "openai", "anthropic"],
