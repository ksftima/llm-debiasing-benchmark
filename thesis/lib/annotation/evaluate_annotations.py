...
DATASETS = {
    ...
    "vuamc (deepseek)":               Path("thesis/datasets/annotated/vuamc/vuamc_deepseek_annotated.csv"),
    "vuamc (gpt54)":                  Path("thesis/datasets/annotated/vuamc/vuamc_gpt54_annotated.csv"),
    "vuamc (mistral)":                Path("thesis/datasets/annotated/vuamc/vuamc_mistral_annotated.csv"),
    "vuamc (llama)":                  Path("thesis/datasets/annotated/vuamc/vuamc_llama_annotated.csv"),
    "vuamc (claude)":                 Path("thesis/datasets/annotated/vuamc/vuamc_claude_annotated.csv"),
